<?php global $current_user; 
    ...
    //echo "<pre>"; print_r($wpmp_list);     echo "</pre>";
    @extract($wpmp_list); 
    //print_r($wpmp_list);
?>
<?php
...
<ul>
    <li><div class=""><div class="div_title"><?php echo __("Title:","wpmarketplace");?></div> <input type="text" class="span span12 col-md-12"  value="<?php echo $product['post_title']; ?>" name="product[post_title]" id="title"></div> </li>
   ...
   <li class="full"><div class="well"><div class="div_title"><?php echo __("Excerpt:","wpmarketplace");?></div><textarea class="span span12 col-md-12" cols="40" rows="3" name="product[post_excerpt]" id="exc"><?php echo $product['post_excerpt']; ?></textarea></div></li>                                                
    ...
    <div class="row-fluid row" id="dpro">
    
    <div id="product_upload_box"  class="span6 col-md-6">  
<div id="currentfiles">
...
<nobr>
<b><i class="glyphicon glyphicon-remove icon-remove" rel="del" id="del_<?php echo $mm;?>" ></i>&nbsp;<?php echo  $filename; ?></b>
</nobr>
...
<script type="text/javascript">
 ...
 jQuery('#del_<?php echo $mm;?>').click(function(){
     ...
     if(jQuery(this).attr('rel')=='del'){
            ...
            jQuery(this).removeClass('glyphicon-remove icon-remove');
            jQuery(this).addClass('glyphicon-refresh icon-refresh');        
            ...
            jQuery(this).addClass('glyphicon-remove icon-remove');
            jQuery(this).removeClass('glyphicon-refresh icon-refresh');
        }
});
...
<div class="clear"></div>
    ...
    <div id="demo_box" class="col-md-6 span6">
    
     <div>
         <div class="form-group">
            <label ><?php echo __("Frontend Demo URL:","wpmarketplace"); ?></label>
            <input type="text" name="wpmp_list[demo_site]" value="<?php echo $demo_site; ?>" class="form-control" />
         </div>
        <div class="form-group">
            <label ><?php echo __("Admin Demo URL:","wpmarketplace"); ?></label>
            <input type="text" name="wpmp_list[demo_admin]" value="<?php echo $demo_admin; ?>" class="form-control" />
         </div>
        <div class="form-group">
            <label ><?php echo __("Username:","wpmarketplace"); ?></label>
            <input type="text" name="wpmp_list[demo_username]"  value="<?php echo $demo_username; ?>" class="form-control" />
         </div>
        <div class="form-group">
            <label ><?php echo __("Password:","wpmarketplace"); ?></label>
            <input type="text" name="wpmp_list[demo_password]" value="<?php echo $demo_password; ?>" class="form-control" />
         </div>
        <div class="form-group">
            <label ><?php echo __("Other Demo Info:","wpmarketplace"); ?></label>
            <textarea name="wpmp_list[demo_info]" class="form-control"><?php echo $demo_info; ?></textarea>
         </div>
     </div>
    ...
    <h3 id="variation_heading"><?php if($price_variation) echo __("Variation Options","wpmarketplace");else echo __("Pricing","wpmarketplace");?></h3>
     ...
     <tr id="base_price" style="<?php //if($price_variation) echo "display: none;"; else echo "";?>"><td><?php echo __("Price:","wpmarketplace");?> <input type="text" size="16" id="base_price" class="input-small" name="wpmp_list[base_price]"  value="<?php echo $base_price;?>"></td>
     <td width="250px"><?php echo __("Sales Price:","wpmarketplace");?> <input type="text" name="wpmp_list[sales_price]" id="sales_price" value="<?php echo $sales_price;?>" size="16" class="input-small" ></td></tr>
     <tr id="sales_expire">
        <td><label for="sales_expire1"><?php echo __('Sales Price Expire Date: ', 'wpmarketplace'); ?></label>
        <input type="text" id="sales_expire1" name="wpmp_list[sales_price_expire]"  value="<?php if(isset($sales_price_expire)) {echo "$sales_price_expire"; } ?>" />
        </td>
        <td>&nbsp;</td>
    </tr>
     <tr id="wpmp-variation"><td><input type="checkbox" <?php if($price_variation) echo "checked='checked'"; else echo "";?> name="wpmp_list[price_variation]" id="price_variation" name="price_variation"> <?php echo __("Variation","wpmarketplace");?></td><td>&nbsp;</td></tr>       
    </table>
    ...
    if($variation){
        ...
        foreach($variation as $key=>$vname){
         ...
         <i class="delet_vdiv glyphicon glyphicon-remove icon-remove" rel="variation_div_<?php echo $key;?>" title="delete this variation" ></i>
...
?>
         <tr id="voption<?php echo $optionkey;?>"><td><input type="text" name="wpmp_list[variation][<?php echo $key;?>][<?php echo $optionkey;?>][option_name]"  placeholder="option name" value="<?php echo $optionval['option_name'];?>"></td><td><input type="text" name="wpmp_list[variation][<?php echo $key;?>][<?php echo $optionkey;?>][option_price]" id="" placeholder="price" value="<?php echo $optionval['option_price'];?>"></td><td><i class="delet_voption glyphicon glyphicon-remove icon-remove" rel="voption<?php echo $optionkey;?>" title="delete this option" ></i></td></tr>
         <?php
            }
        }
    }
...
?>
         ...
         <i class="delet_vdiv glyphicon glyphicon-remove icon-remove" rel="variation_div1" title="delete this variation" ></i>
         ...
         <tr id="voption1"><td><input type="text" name="wpmp_list[variation][1][1][option_name]"  placeholder="option name"></td><td><input type="text" name="wpmp_list[variation][1][1][option_price]" id="" placeholder="price"></td><td><i class="delet_voption glyphicon glyphicon-remove icon-remove" rel="voption1" title="delete this option"></i></td></tr>
         </table>
         <div style="clear: both;"></div>
...
?>
    ...
    jQuery('#add_variation').live("click",function (){
        ...
        jQuery('#vdivs').append('<div id="variation_div_'+tm+'" class="wpmp-variation well" width="100%" style="margin: 10px; "><i class="delet_vdiv glyphicon glyphicon-remove icon-remove" rel="variation_div_'+tm+'" title="delete this variation"></i><table border="0" id="voption_table_'+tm+'"><tr><td><label>Multiple Select:</label></td><td><input type="checkbox" name="wpmp_list[variation]['+tm+'][multiple]" placeholder="Multiple Select"></td></tr><tr><td colspan="3"><input type="text" name="wpmp_list[variation]['+tm+'][vname]" id="" placeholder="variation name "></td></tr><tr id="voption_'+tm+'"><td><input type="text" name="wpmp_list[variation]['+tm+']['+tm+'][option_name]" id="" placeholder="option name"></td><td><input type="text" name="wpmp_list[variation]['+tm+']['+tm+'][option_price]" id="" placeholder="price"></td><td><i class="delet_voption glyphicon glyphicon-remove icon-remove" rel="voption_'+tm+'" title="delete this option" ></i></td></tr></table><div style="clear: both;"></div><input type="button" class="btn btn-info btn-mini  add_voption" rel="'+tm+'" value="Add Option"></div>');
    });
   ...
   <!-- </div>-->
    ...
    <?php echo "<li>".apply_filters('wpmp_frontend_metabox',$product['ID']) . "</li>" ; ?>
...
<div class="form product-form ap-sidebar" >
 ...
 <div class="well"><div class="div_title">Product Types</div>
    ...
    ?>
     ...
     <li><div class="well">
     <div class="row row-fluid">        
     <div class="div_title col-md-6 span5"><?php echo __("Featured Image","wpmarketplace");?></div>  
...
<div id="mi" style="position:relative">
     ...
     <div class="div_title col-md-7 span7"><?php echo __("Additional Images","wpmarketplace");?></div>
      <div class="col-md-4 span4">
    <?php
...
<?php
    ...
    if(is_array($images)){
        foreach($images as $mpv){
            ...
            ?>
             <li id='<?php echo ++$mmv; ?>' >
             <div class="adp" style="float:left;padding:5px; position: relative;">
             <input type='hidden'  id='in_<?php echo $mmv; ?>' name='wpmp_list[images][]' value='<?php echo $mpv; ?>' />
             <i style='z-index:9999;cursor:pointer;padding:5px;background: #111;border-radius:4px;top:0px;position:absolute; color: #bdbdbd; width: auto; font-size: 8px;' id='del_<?php echo $mmv; ?>' rel="<?php echo $mmv; ?>"  class="del_adp glyphicon glyphicon-remove icon-remove" align=left ></i>
...
?>    
     ...
     <tr><td><input placeholder="Code" type="text" size="8" id="coupon_code" class="span"  value=""></td><td><input placeholder="Discount" type="text" class="span" size="8" id="coupon_discount"  value=""></td>
