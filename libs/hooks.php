...
add_filter("wpmp_product_price", "wpmp_weightndim");
...
//short code for buyers member area
add_shortcode("wpmp-frontend-buyer","wpmp_frontend_buyer");

//short code for saler 
add_shortcode("wpmp-frontend-saler","wpmp_frontend_saler");
