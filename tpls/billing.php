        ...
        <div style="<?php if ($current_user->ID) echo "";
            ...
            <div id="customer_details" class="row row-fluid">
                <div class="col-md-6 span6">            
                    ...
                    <div class="checkbox">
                        <label  class="checkbox" for="shiptobilling-checkbox"><?php echo __("Ship to same address?", "wpmarketplace"); ?>
                ...
                <div class="col-md-6 span6" id="shipping-address">
                    ...
                    <div class="shipping_address" style="display: block;">
                        ...
                        <div id="shipping_first_name_field" class="form-group">
                        ...
                        <div id="shipping_last_name_field" class="form-group">
                        ...
                        <div id="shipping_company_field" class="form-row ">
                        ...
                        <div id="shipping_address_1_field" class="form-group">
                        ...
                        <div id="shipping_address_2_field" class="form-group">
                        ...
                        <div id="shipping_city_field" class="form-group">
                        ...
                        <div id="shipping_postcode_field" class="form-group update_totals_on_change">
                        ...
                        <div id="shipping_country_field" class="form-group update_totals_on_change country_select">
                        ...
                        <div id="shipping_state_field" class="form-group update_totals_on_change">
                            <label class="" for="shipping_state"><?php echo __("State/County", "wpmarketplace"); ?> <abbr title="required" class="required">*</abbr></label>
