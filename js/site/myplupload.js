            ...
            uploader.bind('FileUploaded', function(up, file, response) {
                ...
                if(imgId=="img1"){
                    ...
                    jQuery.post(ajaxurl,
                    {
                      ...
                      fname=res;  
                      jQuery('#adpcon').append("<li id='li_"+file.id+"'><div id='"+file.id+"' style='float:left;padding:5px;position:relative;' class='adp'><input type='hidden' id='in_"+file.id+"' name='wpmp_list[images][]' value='"+fname+"' /><nobr><b><i style='z-index:9999;cursor:pointer;padding:5px;background: #111;border-radius:4px;top:0px;position:absolute; color: #bdbdbd; width: auto; font-size: 8px;' id='del_"+file.id+"'  rel='li_"+file.id+"' class='del_adp glyphicon glyphicon-remove icon-remove' align=left></i><img src='"+pluginurl+"libs/timthumb.php?w=50&h=50&zc=1&src="+uploadimgurl+fname+"'/></b></nobr><div style='clear:both'></div></div></li>");
                    });
                ...
                if(imgId=="fimg"){
                    ...
                    jQuery.post(ajaxurl,
                    {
                      ...
                      fname=res;  
                      jQuery('#mi').html("<img src='"+pluginurl+"libs/timthumb.php?w=220&zc=1&src="+fname+"'/><br/><img style='z-index:9999;cursor:pointer;' id='mi_del' rel='mi' src='"+pluginurl+"images/remove.png' alt='Remove Featured Image' align=left />");
                    });
                ...
                if(imgId=="clogo"){
                    ...
                    jQuery('.filelist').html("<img src='"+pluginurl+"libs/timthumb.php?w=70&zc=1&src="+response+"'/><i style='position:absolute;z-index:9999;cursor:pointer;' class='glyphicon glyphicon-remove icon-remove' id='logo_"+file.id+"'></i>");
                ...
                if(imgId=="img2"){
                    ...
                    jQuery.post(ajaxurl,
                    {
                      ...
                      var nm = fname;
                        ...
                        jQuery('#currentfiles').prepend("<div id='"+file.id+"' style='display:none' class='cfile'><input type='hidden' id='in_"+file.id+"' name='wpmp_list[file][]' value='"+fname+"' /><nobr><b><i id='del_"+file.id+"'  rel='del' class='glyphicon glyphicon-remove icon-remove' align=left ></i>&nbsp;"+nm+"</b></nobr><div style='clear:both'></div></div>");
